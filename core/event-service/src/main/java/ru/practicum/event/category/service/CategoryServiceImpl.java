...
public class CategoryServiceImpl implements CategoryService {
    ...
    public void delete(long catId) {
        ...
        List<Event> events = eventRepository.findAllByCategoryIdIn(Set.of(catId));
        if (!events.isEmpty()) {
